...
class FormPage(BasePage):
    ...
    def fill_form_fields(self):
        ...
        self.element_is_visible(self.locators.SUBJECT).send_keys("Economics")
    ...
    def form_result(self):
        result_table = self.element_is_present(self.locators.RESULT_TABLE)
        # result = self.element_is_present(self.locators.ALL_RESULT_TABLE)
        result = result_table.find_element(By.XPATH, self.locators.RESULT_TABLE)
        # print(result_list)
        data = []
        for item in result:
