...
class DynamicPropertiesPage(BasePage):
    ...
    def check_enable_button(self):
        try:
            self.element_is_visible(self.locators.ENABLE_BUTTON)
        except TimeoutException:
            return False
        return True

    def check_changed(self):
        color_button = self.element_is_present(self.locators.COLOR_CHANGE_BOTTON)
    ...
    def check_appear_of_button(self):
        try:
            self.element_is_visible(self.locators.VISIBLE_AFTER_FIVE_SEC_BOTTON)
        except TimeoutException:
            return False
        return True
